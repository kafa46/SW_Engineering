...
if __name__=='__main__':
    ...
    processor_debit = DebitPaymentProcessor("2349875")
    processor_debit.auth_sms('465839')
    processor_debit.pay(order)

    processor_credit = CreditPaymentProcessor("2349875")
    processor_credit.pay(order)

    processor_paypal = PaypalPaymentProcessor("2349875")
    processor_paypal.auth_sms('465839')
